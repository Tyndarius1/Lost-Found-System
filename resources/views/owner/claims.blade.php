...
<style>
    ...
    .skeleton-img { width: 70px; height: 70px; border-radius: 1rem; }
    .skeleton-badge { width: 80px; height: 24px; border-radius: 50px; }
    .skeleton-btn { width: 90px; height: 32px; border-radius: 50px; }
...
<div class="container pb-5">
    <div id="skeleton-loader">
        <div class="d-flex justify-content-between align-items-center mb-5">
            <div>
                <div class="skeleton" style="width: 280px; height: 35px; border-radius: 8px; margin-bottom: 8px;"></div>
                <div class="skeleton skeleton-text" style="width: 400px;"></div>
            </div>
            <div class="skeleton skeleton-badge" style="width: 120px; height: 40px;"></div>
        </div>
            ...
            <div class="col-12">
                <div class="card border-0 shadow-sm p-4" style="border-radius: 20px;">
                    <div class="row align-items-center">
                        <div class="col-auto"><div class="skeleton skeleton-img"></div></div>
                        <div class="col px-md-4">
                            <div class="d-flex gap-2 mb-2"><div class="skeleton" style="width: 180px; height: 22px;"></div><div class="skeleton skeleton-badge"></div></div>
                            <div class="skeleton skeleton-text" style="width: 150px;"></div>
                            <div class="skeleton" style="height: 50px; border-radius: 10px; width: 100%;"></div>
                        </div>
                        <div class="col-auto text-end">
                            <div class="skeleton skeleton-badge mb-3 ms-auto"></div>
                            <div class="d-flex gap-2"><div class="skeleton skeleton-btn"></div><div class="skeleton skeleton-btn"></div></div>
                        </div>
                    </div>
                </div>
            </div>

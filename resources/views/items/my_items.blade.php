...
<style>
    ...
    .skeleton-text { height: 15px; border-radius: 4px; margin-bottom: 8px; }
    .skeleton-img { width: 85px; height: 85px; border-radius: 1rem; }
    .skeleton-badge { width: 60px; height: 20px; border-radius: 50px; }
                ...
                <div class="card border-0 shadow-sm p-3" style="border-radius: 20px;">
                    <div class="row align-items-center">
                        ...
                        <div class="col px-md-4">
                            <div class="d-flex gap-2 mb-2"><div class="skeleton skeleton-badge"></div><div class="skeleton" style="width: 150px; height: 20px;"></div></div>

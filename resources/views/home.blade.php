...
<style>
    ...
    .skeleton-title { height: 32px; border-radius: 8px; margin-bottom: 10px; }
    .skeleton-text { height: 16px; border-radius: 4px; margin-bottom: 8px; }
    .skeleton-card { height: 280px; border-radius: 20px; }
    .skeleton-circle { width: 50px; height: 50px; border-radius: 50%; }
    .skeleton-row { height: 60px; border-radius: 10px; margin-bottom: 10px; }
        ...
        <div class="row g-4 mb-5">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card border-0 shadow-sm h-100 p-4" style="border-radius: 20px;">
                    <div class="skeleton skeleton-circle mb-4"></div>
                    <div class="skeleton skeleton-title" style="width: 70%;"></div>
                    <div class="skeleton skeleton-text"></div>
                    <div class="skeleton skeleton-text" style="width: 90%;"></div>
                    <div class="skeleton mt-3" style="height: 40px; border-radius: 50px;"></div>
                </div>
            </div>
            @endfor
        </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card border-0 shadow-sm p-4" style="border-radius: 20px;">
                    <div class="skeleton skeleton-title mb-4" style="width: 200px;"></div>
            ...
            <div class="col-12">
                <div class="card border-0 shadow-sm" style="border-radius: 20px;">
                    <div class="card-header bg-white border-0 pt-4 px-4 d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('items.user') }}" class="small text-decoration-none">View All</a>
                    </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        }, 1000); // 1-second delay for smooth reveal
    });
</script>
@endsection